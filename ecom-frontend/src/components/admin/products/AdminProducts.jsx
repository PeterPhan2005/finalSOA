...
const onDeleteHandler = () => {
  ...
  const hasNoProductsAtAll = !pagination || pagination?.totalElements === 0;
  // Check if current page is empty but there are products in other pages
  const currentPageEmpty = (!products || products?.length === 0) && !hasNoProductsAtAll;
  ...
  return (
    ...
    {!hasNoProductsAtAll && !currentPageEmpty && (
        ...
        <div className='max-w-full'>
          {currentPageEmpty && (
            <div className='text-center text-gray-500 py-4'>
              <p>No products on this page. Try navigating to a different page.</p>
            </div>
          )}
          <DataGrid
            className='w-full'
